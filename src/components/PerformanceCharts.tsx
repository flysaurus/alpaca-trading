...
function CustomTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="card border dark:border-[#334155]/70 light:border-[#e2e8f0] rounded-lg px-3 py-2 shadow-2xl">
...
function StatCard({ label, value, subtext, hint, color }: { label: string; value: string; subtext?: string; hint?: string; color?: string }) {
  return (
    <div className="card border dark:border-[#334155]/70 light:border-[#e2e8f0] rounded-xl p-3 flex flex-col">
...
export function PerformanceCard({
  ...
  return (
    <div className="card border dark:border-[#334155]/70 light:border-[#e2e8f0] p-4">
      {/* Header + Time Range */}
