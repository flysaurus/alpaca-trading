...
export default function AIThinkingIndicator({
  ...
  const messages = STATUS_MESSAGES[mode] || STATUS_MESSAGES.general
  ...
  return (
    <div className="flex items-start gap-3 mb-4">
      {/* Fox avatar */}
      <div className="w-8 h-8 rounded-full bg-slate-700 flex items-center justify-center flex-shrink-0 text-base">
        🦊
      </div>
